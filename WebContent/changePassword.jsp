...
<html>
<head>
<title>Change Password Employee -> Khokar Public School</title>
<meta charset="UTF-8">
...
function UpdatePass()
{
	...
	xhttp.open("GET", "RealtimeData?work_to_do=change_pass&new_pass=" + confirm_pass.value + "&old_pass=" + old_password, true);
	xhttp.send();
}
