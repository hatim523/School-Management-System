...
<html>
<head>
<title>Add Course -> Khokar Public School</title>
<meta charset="UTF-8">
        ...
        <div class="w3-col m12" >
          <div class="w3-card w3-round w3-white" >
            <div class="w3-container w3-padding" >
				      ...
				      <input type="text" placeholder="Enter Subject" class="form-control" id="course_name" required>
					      
					    <br><label><b>Total Subject Marks:</b></label><br>
					    <input type="number" placeholder="Enter Subject" class="form-control" id="marks" min="0" max="100" required>
					    
					    <br><button type="submit" style="background-color:#ccc" onclick="getCourse()">Add Course</button> 
            </div>
          </div>
        </div>
      </div>
...
function getCourse()
{
	...
	var class_id = document.getElementById('marks').value;
	...
	xhttp.open("GET", "RealtimeData?work_to_do=course_add&name=" + course_name + "&class=" + class_id, true);
	xhttp.send();
}
