        ...
        <div class="w3-col m12" >
          <div class="w3-card w3-round w3-white" >
            <div class="w3-container w3-padding" >
				      ...
				      <input type="text" placeholder="Enter Class" class="form-control" id="class_name" required>
					      
					    <br><label><b>Section:</b></label><br>
					    <input type="text" placeholder="Enter Section" class="form-control" id="section"  required>
					    
					    <br><button type="submit" style="background-color:#ccc" onclick="getCourse()">Add Class</button> 
            </div>
          </div>
        </div>
      </div>
...
function getCourse()
{
	...
	var class_id = document.getElementById('section').value;
	...
	xhttp.open("GET", "RealtimeData?work_to_do=class_add&class_name=" + course_name + "&section=" + class_id, true);
	xhttp.send();
}
